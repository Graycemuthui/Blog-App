...
RSpec.feature 'Post Index Page', type: :feature do
  before :each do
    @user = User.create(name: 'Lilly', photo: '<img src="http://grayce.com/co/png" alt="user avatar">', bio: 'Teacher from Poland.',
                        posts_counter: 0)
    @user2 = User.create(name: 'Tom', photo: '<img src="http://grayce.com/co/png" alt="user avatar">', bio: 'Teacher from Poland.',
                         posts_counter: 0)
